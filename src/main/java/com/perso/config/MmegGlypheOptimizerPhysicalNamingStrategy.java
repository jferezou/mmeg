...
public class MmegGlypheOptimizerPhysicalNamingStrategy implements PhysicalNamingStrategy, Serializable {
    private Map<Identifier, Identifier> schemaMapping;

    public MmegGlypheOptimizerPhysicalNamingStrategy(final Map<String, String> logSchema2phySchemas) {
